...
public class Config extends Vigilant {
    ...
    @Property(
            ...
            description = "Automatically close any book GUI in all Hypixel lobbies. Originally designed to automate ignoring all those books about Hypixel's occasional sales on their online store, but §efalse positives CAN and WILL happen.\n§c§lEnable with caution, and disable when in doubt!",
